  ...
  font-style: normal;
    ...
    <body class="font-sans antialiased">
        <div class="flex flex-col justify-between min-h-screen bg-gradient-to-b from-red-700 to-red-800">
            ...
            <footer class="py-5 sm:py-10 px-1 md:px-10 border-t-[10px] sm:border-t-[16px] xl:border-t-[18px] 2xl:border-t-[20px] border-white flex flex-col sm:flex-row items-center justify-between bg-gradient-to-b  from-green-800 to-green-900">
                <p class="text-[1rem] sm:text-lg md:text-xl lg:text-2xl xl:text-3xl text-white font-black pb-3 sm:pb-0 sm:pt-4 xl:pt-0">Dedicated to the memory of Kelvin Kiptum</p>
