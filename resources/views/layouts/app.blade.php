  ...
  font-style: normal;
    ...
    <body class="font-sans antialiased">
        ...
        @endif
                ...
                <footer class="pt-2 pb-5 px-2 sm:px-6 border-t-[10px] sm:border-t-[16px] xl:border-t-[18px] 2xl:border-t-[20px] border-white flex flex-col sm:flex-row  items-center justify-between  bg-gradient-to-b  from-green-800 to-green-900">
                    <div class="text-white text-left text-xs sm:text-sm lg:text-base xl:text-xl w-full sm:w-1/2 mt-5">
