  ...
  font-style: normal;
    ...
    <body class="font-sans antialiased">
        <div class="flex flex-col justify-between h-screen">
            ...
            <footer class="py-5 sm:py-10 px-1 md:px-10 border-t-[10px] sm:border-t-[16px] xl:border-t-[18px] 2xl:border-t-[20px] border-white flex flex-col sm:flex-row items-center justify-between bg-[#006600ff]">
