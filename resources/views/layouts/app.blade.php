...
.architects-daughter-regular {
  ...
  font-style: normal;
    ...
    <body class="font-sans antialiased">
        <div class="flex flex-col h-screen justify-between bg-[#bc0000ff]">
            @include('layouts.navigation')
            <!-- Page Content -->

                {{ $slot }}

            <footer class="py-10 px-1 md:px-10 border-t-[20px] border-white flex items-center justify-between bg-[#006600ff]">
                <p class="text-sm xs:text-lg md:text-2xl xl:text-3xl text-white font-black ">Dedicated to the memory of Kelvin Kiptum</p>
