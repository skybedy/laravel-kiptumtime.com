...
.architects-daughter-regular {
  ...
  font-style: normal;
    ...
    <body class="font-sans antialiased">
        <div class="flex flex-col justify-between bg-[#bc0000ff] h-screen">
            @include('layouts.navigation')
            <!-- Page Content -->

                {{ $slot }}

            <footer class="py-10 px-1 md:px-10 border-t-[10px] sm:border-t-[20px] border-white flex flex-col sm:flex-row items-center justify-between bg-[#006600ff]">
                <p class="text-lg md:text-2xl xl:text-3xl text-white font-black pb-6 sm:pb-0">Dedicated to the memory of Kelvin Kiptum</p>
