  ...
  font-style: normal;
    ...
    <body class="font-sans antialiased">
        ...
        @endif
                ...
                <footer class="py-12 border-t-[10px] sm:border-t-[16px] xl:border-t-[18px] 2xl:border-t-[20px] border-white flex flex-col  items-center justify-center space-y-8 bg-gradient-to-b  from-green-800 to-green-900">
                    <div class="text-white text-center text-xs sm:text-sm lg:text-xs xl:text-xl font-black">
                        <p class="underline">This platform dedicated to the memory of KELVIN KIPTUM and it's a running challenge based on his world record time 2:00:35 and in this challenge you can try to cover as much distance as possible within this time</p>
                    </div>
                    <div class="w-1/4">
