 ...
 <x-h2 style="style-1" class="clear-both">Starting fee</x-h2>
    ...
    <form method="post" action="{{ route('registration.checkout') }}">
        ...
        <div class="flex justify-between">
            <x-p style="style-1" class="w-1/2 md:w-2/3">
            ...
            <div class="flex justify-center items-center w-1/2 md:w-1/3 ms-5">
                <input type="number" name="price" id="amount" class="block w-full text-8xl md:text-8xl text-center rounded-md border-2 border-black" value="10" />
            </div>
